...
const schemaRequestServiceForURL = (uri) => {
    ...
    return request_light_1.xhr({ url: uri, followRedirects: 5, headers }).then(response => response.responseText, (error) => Promise.reject(error.responseText || error.toString()));
};
suite('JSON Schema', () => {
    ...
    test('Modifying schema', () => __awaiter(this, void 0, void 0, function* () {
        const service = new SchemaService.YAMLSchemaService(requestServiceMock, workspaceContext);
        service.setSchemaContributions({
            schemas: {
                'https://myschemastore/main/schema1.json': {
    ...
    test('Deleting schema', () => __awaiter(this, void 0, void 0, function* () {
        const service = new SchemaService.YAMLSchemaService(requestServiceMock, workspaceContext);
        service.setSchemaContributions({
            schemas: {
                'https://myschemastore/main/schema1.json': {
    ...
    test('Modifying schema works with kubernetes resolution', () => __awaiter(this, void 0, void 0, function* () {
    ...
    test('Deleting schema works with Kubernetes resolution', () => __awaiter(this, void 0, void 0, function* () {
        const service = new SchemaService.YAMLSchemaService(schemaRequestServiceForURL, workspaceContext);
        service.registerExternalSchema(schemaUrls_1.KUBERNETES_SCHEMA_URL);
        yield service.deleteContent({
            action: yamlSchemaService_1.MODIFICATION_ACTIONS.delete,
    ...
    test('Adding a brand new schema', () => __awaiter(this, void 0, void 0, function* () {
        const service = new SchemaService.YAMLSchemaService(schemaRequestServiceForURL, workspaceContext);
    ...
    test('Deleting an existing schema', () => __awaiter(this, void 0, void 0, function* () {
        const service = new SchemaService.YAMLSchemaService(schemaRequestServiceForURL, workspaceContext);
        service.saveSchema('hello_world', {
            enum: [
                'test1',
