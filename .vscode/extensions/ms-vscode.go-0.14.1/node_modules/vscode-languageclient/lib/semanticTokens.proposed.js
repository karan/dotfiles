...
(function (protocol2code) {
    ...
    function asLedgend(value) {
        return value;
    }
    protocol2code.asLedgend = asLedgend;
...
class SemanticTokensFeature extends client_1.TextDocumentFeature {
    ...
    fillClientCapabilities(cap) {
        ...
        capability.tokenTypes = [
            ...
            vscode_languageserver_protocol_1.Proposed.SemanticTokenTypes.marco,
    ...
    registerLanguageProvider(options) {
        ...
        const rangeProvider = hasRangeProvider
            ...
            : undefined;
        const disposables = [];
        const legend = protocol2code.asLedgend(options.legend);
